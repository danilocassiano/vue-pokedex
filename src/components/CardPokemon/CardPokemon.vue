<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div
      :class="`relative rounded-lg shadow-lg p-4 w-80 transition duration-300 ease-in-out`"
    ...
    >
      ...
      <div class="relative z-10">
        <div class="flex items-center mb-2">
          ...
          <h2 class="text-xl font-bold text-white capitalize flex-grow">
            {{ pokemon.name }}
          </h2>
          <span class="text-white text-lg font-bold ml-auto">
        ...
        <img
          ...
          alt="Pokemon Image"
          class="h-52 w-52 mx-auto mb-4"
        />

        <div class="mt-[-40px] bg-white p-2 rounded-lg shadow">
          <div class="flex justify-center space-x-2 mt-6">
            <span
              v-for="(type, index) in pokemon.types"
              :key="index"
              :style="{ backgroundColor: getTypeColor(type) }"
              class="px-2 py-1 rounded-full text-sm text-white"
            >
              {{ type }}
            </span>
          </div>
          ...
          <div class="flex justify-center items-center mt-1 space-x-4 text-gray-700">
          ...
          <div class="grid grid-rows-3 mt-2 text-gray-700">
            ...
            >
              ...
              <div class="flex-1 bg-gray-200 rounded-full h-1.5 overflow-hidden"> <!-- Adicionado overflow-hidden -->
                <div
